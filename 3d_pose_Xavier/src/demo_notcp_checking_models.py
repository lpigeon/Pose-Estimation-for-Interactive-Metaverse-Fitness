...
logistic_model = joblib.load('./pkl/Logistic.pkl')
...
if __name__ == '__main__':
    ...
    while(video.isOpened()):
        ...
        lgpred = logistic_model.predict(detected_data.reshape(1,-1))
        
        print('rf pred....',rfpred)
        print('lg pred....',lgpred)
        ...
        if (lg_counting_time >=3) and (lgpred == 'UP'):
            lg_count +=1
        ...
        print('Random forest COUNTS : ......',rf_count)
        print('Linear Regression COUNTS : ..',lg_count)
